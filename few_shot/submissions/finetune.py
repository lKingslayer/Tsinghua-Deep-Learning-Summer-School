...
TASK = SOFTMAX    # choose Softmax regression method
#TASK = FINETUNING # choose fintuning method
SHOTS = [1,5,20,50][1]
...
with tf.name_scope("train"):
    ...
    if TASK == SOFTMAX:
        ...
        train_op1 = optimizer1.apply_gradients(list(gradients)[:2])
        optimizer2 = tf.train.GradientDescentOptimizer(learning_rate[1])
        train_op2 = optimizer2.apply_gradients(list(gradients)[2:])
